...
shoppingCart.push("Pair of pink socks", "Pair of pink socks",  "Pair of pink socks");
...
console.log(shoppingCart.includes("Sunglasses") ? "There are already sunglasses in the cart" : shoppingCart.push("Sunglasses"));
...
let last3Items = shoppingCart.slice(-3)
...
console.log(shoppingCart.length < 10 ? shoppingCart.push("Green hoodie") : `With ${shoppingCart.length} items in your cart, you have enough stuff already.`);
